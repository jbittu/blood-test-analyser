...
from tools import search_tool, ReadBloodReportTool, NutritionTool, ExerciseTool

# Instantiate the tools
read_data_tool = ReadBloodReportTool()
nutrition_tool = NutritionTool()
exercise_tool = ExerciseTool()

# Task 1: Help patients based on blood report and query
help_patients = Task(
...
nutrition_analysis = Task(
    ...
    agent=nutritionist,
    tools=[read_data_tool, nutrition_tool],
    async_execution=False
)
...
exercise_planning = Task(
    ...
    tools=[read_data_tool, exercise_tool],
    async_execution=False
)
